...
const CommunityPostDetail: NextPage = () => {
  ...
  const [sendReply, { data: replyData, loading: replyLoading }] =
    useMutation<ReplyResponse>(`/api/posts/${router.query.id}/reply`);
          ...
          {data?.post.answers.map((answer) => (
            <div key={answer.id} className="flex items-start space-x-3">
              ...
              <div>
                ...
                <span className="text-xs text-gray-500 block ">Create At</span>
